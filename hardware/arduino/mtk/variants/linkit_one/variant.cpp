...
{
  { VM_DCL_HANDLE_INVALID, 13, PIO_END, 1  },      // D0 /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_EINT / VM_DCL_PIN_MODE_PWM */ // pwm can not use it
  ...
  { VM_DCL_HANDLE_INVALID, 19, PIO_END, 1  },      // D5 /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_PWM */ // pwm can not use it ??
